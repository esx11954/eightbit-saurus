...
[演習用ファイル](https://drive.google.com/drive/folders/1-F3KFwuE3gxNuEqQgZ0FE_A0p7odn2DW?usp=drive_link)
...
### 留意点
・装飾よりも構造を優先する<br />
・誇張表現や推測ではなく事実を重視する<br />
※Gensparkの無料枠のクレジットを使い切った場合は、類似サービス「[Gammma](https://gamma.app/ja)」を使用してください。
    </div>
</details>
...
ここでは「業務資料として違和感がない表紙」を生成する指示文を意識してください。
...
[day3最終課題ファイル](https://drive.google.com/drive/folders/1-GDFiaGNw7gFmIpCBIHm-86Qk4U3YG4h?usp=drive_link)
