...
<div style={{ display: 'flex', gap: '30px', alignItems: 'center', marginBottom: '20px' }}>
  ...
  {/* 左側：テキストエリア */}
  <div style={{ flex: 1.5, lineHeight: '1.2' }}>
    <p style={{ marginTop: '0', fontWeight: 'bold', marginBottom: '8px' }}>【概要】</p>
    <p style={{ marginBottom: '12px' }}>
      幹線工事とは、受変電設備（キュービクル）から各階の分電盤、動力制御盤、大型機器へと電気のメインルートを構築する作業です。建物全体に張り巡らされる回路の中で、最も太く大きな電力を運ぶ「大動脈」を形作る工程と言えます。
    </p>

    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【目的】</p>
    <p style={{ marginBottom: '12px' }}>
      外部から供給された膨大なエネルギーを、建物内の隅々まで安全かつ効率的に送り届けるインフラを確立することにあります。この幹線が、照明やコンセントへつながる建物の機能と信頼性の土台となります。
    </p>

    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【各種ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・施工面：垂直貫通部が火災時の煙突にならないよう「延焼防止処理」を徹底する。<br />
      ・品質面：通電前に「メガー（絶縁抵抗測定器）」で漏電リスクがないか厳密に検査する。<br />
    </div>
  </div>
  ...
  <div style={{ flex: 1, textAlign: 'center' }}>
    <img 
      src={require('./img/kansen.png').default} 
      alt="幹線工事の様子"
      style={{ 
        width: '100%', 
        maxWidth: '400px', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/juhenndenn.png').default} 
      alt="受変電設備（キュービクル）"
      style={{ 
        width: '100%', 
        height: '100%', 
        objectFit: 'cover', /* 画像を枠いっぱいに広げて高さを揃える */
        borderRadius: '8px',
  ...
  {/* 右側：テキストエリア */}
  <div style={{ flex: 1.5, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    <p style={{ marginTop: '0' }}>
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1.5, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【各種ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・管材の使い分け：電線そのものを保護し、安全・効率的に配線するため、天井裏に適した「PF管」、コンクリート埋設専用の「CD管」、衝撃に強い「金属管」を用途に合わせて正しく選定します。<br />
      ・品質管理：通線時に電線を傷つけないよう「曲げ半径」が急すぎないか確認します。<br />
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/haisen.png').default} 
      alt="配管・配線工事の様子"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/PF.png').default} 
      alt="PF管の施工例"
      style={{ 
        width: '100%', 
        height: '100%', 
  ...
  <div style={{ flex: 1.5, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/VE.png').default} 
      alt="VE管の施工例"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '20px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/erubo.png').default} 
      alt="エルボ（曲げ用フィッティング）"
      style={{ 
        width: '100%', 
        height: '100%', 
  ...
  <div style={{ flex: 1 }}>
    <img 
      src={require('./img/yunion.png').default} 
      alt="ユニオン（管接続用フィッティング）"
      style={{ 
        width: '100%', 
        height: '100%', 
        objectFit: 'cover', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  {/* 左側：テキストエリア（上寄せ・高さ同期） */}
  <div style={{ flex: 2, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    <p style={{ marginTop: '0', marginBottom: '12px' }}>
  ...
  <div style={{ flex: 0.8, maxWidth: '300px' }}>
    <img 
      src={require('./img/CD.png').default} 
      alt="CD管のコンクリート埋設施工"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1, maxWidth: '350px' }}>
    <img 
      src={require('./img/jakuden.png').default} 
      alt="弱電設備（端子盤・IDF）の様子"
      style={{ 
        width: '100%', 
        height: '100%', 
        objectFit: 'cover', 
  ...
  <div style={{ flex: 1.5, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【各種ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・ノイズ対策：繊細な信号を守るため、強電ケーブルとの離隔距離を厳格に保ちます。<br />
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    <p style={{ marginTop: '0', fontWeight: 'bold', marginBottom: '8px' }}>【概要】</p>
    <p style={{ marginBottom: '12px' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【各種ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・気密性の確保：ガス漏れを防ぐため、接続後に窒素ガスで圧力をかけ、数日間保持する「気密試験」が不可欠です。<br />
      ・保温施工：天井裏での結露発生を防ぐため、配管全体を「保温材」で隙間なく覆い、接続箇所も確実に処理します。<br />
  ...
  <div style={{ flex: 1, maxWidth: '450px' }}>
    <img 
      src={require('./img/reibai.png').default} 
      alt="冷媒配管の施工（室内機接続部）"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 2, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・適切な下り勾配：水の自重で流すため、施工する業者の判断で、1/100以上の下り勾配を維持し、逆勾配やたわみを防ぎます。<br />
      ・結露防止（保温）：排出される冷たい水による配管表面の結露を防ぐため、全体を保温材で隙間なく覆います。<br />
  ...
  <div style={{ flex: 0.8, maxWidth: '300px' }}>
    <img 
      src={require('./img/doren.png').default} 
      alt="ドレン配管の勾配確認と保温施工"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1, maxWidth: '450px' }}>
    <img 
      src={require('./img/kiki.png').default} 
      alt="照明器具や空調機の据付作業"
      style={{ 
        width: '100%', 
        height: '100%', 
  ...
  <div style={{ flex: 1, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・位置と精度の管理：スイッチ等の高さや水平をミリ単位で厳密に管理し、建物の品質を確保します。<br />
      ・耐震・脱落防止：重量物（照明や分電盤）が地震で落下しないよう、補強材へ確実に固定します。<br />
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1.2, maxWidth: '550px' }}>
    <img 
      src={require('./img/keiro.png').default} 
      alt="排水配管の分離と集約の経路図"
      style={{ 
        width: '100%', 
        height: '100%', 
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1.2, maxWidth: '550px' }}>
    <img 
      src={require('./img/syoubou.png').default} 
      alt="連結送水管の送水口と消防設備の様子"
      style={{ 
        width: '100%', 
        height: '100%', 
        objectFit: 'cover', 
  ...
  <div style={{ flex: 1, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・法令遵守と検査：消防法に基づき正確に設置し、消防署による「消防検査」の承認を確実に得るための厳格な管理を行います。<br />
      ・他設備との連動：火災時に空調を停止（防煙連動）させるなど、他業種との複雑な連動制御が正しく動作するかを確認します。<br />
...
<div style={{ display: 'flex', gap: '30px', alignItems: 'stretch', marginBottom: '20px' }}>
  ...
  <div style={{ flex: 1, lineHeight: '1.2', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
    ...
    <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>【ポイント】</p>
    <div style={{ paddingLeft: '5px' }}>
      ・安全精度と法遵守：建築基準法等の厳しい規制を遵守し、利用者の生命を守るための極めて高い設置精度を確保します。<br />
      ・工程管理の連携：工事用エレベーターの設置・解体は他業種の搬入計画に直結するため、現場全体との密接な連携が不可欠です。<br />
  ...
  <div style={{ flex: 1.2, maxWidth: '550px' }}>
    <img 
      src={require('./img/syoukou.png').default} 
      alt="建設現場の工事用エレベーター（昇降設備）"
      style={{ 
        width: '100%', 
        height: '100%', 
        objectFit: 'cover', 
